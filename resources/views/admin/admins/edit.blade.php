            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">{{ __('routes.admins.edit_page') }}</h4>
                    </div>
                    <div class="card-content">
                        <div class="card-body">
                            <form method="POST" action="{{ route('admin.admins.update', ['id' => $row->id]) }}"
                                ...
                                <div class="form-body">
                                    <div class="row">
                                        ...
                                        <x-admin.phone_with_code :countries="$countries" :phone="$row->phone" :countryCode="$row->country_code"/>
                                                ...
                                                <div class="controls">
                                                    <select name="role_id" class="select2 form-control" required
                                                        ...
                                                        @foreach ($roles as $role)
                                                            <option {{ $role->id == $row->role_id ? 'selected' : '' }}

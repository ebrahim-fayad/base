            ...
            <div class="row">
                ...
                <div class="col-md-3 mb-2 mb-md-0">
                    <ul class="nav nav-pills flex-column mt-md-0 mt-1">
                        ...
                        <li class="nav-item">
                            <a class="nav-link d-flex py-75 {{ request('tap') ? '' : 'active' }}" id="account-pill-main" data-toggle="pill"
                        ...
                        <li class="nav-item" style="margin-top: 3px">
                            <a class="nav-link d-flex py-75 {{ request('tap') == 'password' ? 'active' : '' }}" id="account-pill-terms" data-toggle="pill"
                            ...
                            <div class="card-body">
                                <div class="tab-content">
                                        ...
                                        <form action="{{ route('admin.profile.update') }}" method="post"
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6 col-12">
                                                    <div class="form-group">
                                                        <label
                                                            for="first-name-column">{{ __('admin.phone_number') }}</label>
                                                        <div class="controls">
                                                            <input type="number"
                                    ...
                                    <div role="tabpanel" class="tab-pane" id="account-vertical-terms"
                                        ...
                                        <form action="{{ route('admin.profile.update_password',['tap'=>'password']) }}" method="post"
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-4 col-12">
                                                    <div class="form-group">
                                                        <label
                                                            for="first-name-column">{{ __('admin.old_password') }}</label>
                                                        <div class="controls">
                                                            <input type="password" name="old_password"
                                                                class="form-control" required oninput="this.setCustomValidity('')"
                                                ...
                                                <div class="col-md-4 col-12">
                                                    <div class="form-group">
                                                        <label
                                                            for="first-name-column">{{ __('admin.new_password') }}</label>
                                                        <div class="controls">
                                                ...
                                                <div class="col-md-4 col-12">
                                                    <div class="form-group">
                                                        <label
                                                            for="first-name-column">{{ __('admin.new_password_confirm') }}</label>
                                                        <div class="controls">

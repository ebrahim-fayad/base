            ...
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-content">
                        <div class="card-body">
                            <form method="POST" action="{{route('admin.images.update', ['id' => $row->id])}}"
                                        ...
                                        @foreach (languages() as $lang)
                                            <div class="col-md-6 col-12">
                                                <div class="form-group">
                                                    ...
                                                    <div class="controls">
                                                        <input type="text" value="{{$row->getTranslations('title')[$lang]}}" name="title[{{$lang}}]"
                                                            class="form-control" placeholder="{{__('site.write') . __('site.title_' . $lang)}}" required

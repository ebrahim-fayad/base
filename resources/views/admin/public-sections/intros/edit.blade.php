                                        ...
                                        <div class="col-6">
                                            <div class="form-group">
                                                <div class="controls">
                                                    ...
                                                    <textarea class="form-control" name="title[{{$lang}}]" id="" cols="30" rows="10" placeholder="{{__('site.write') . __('site.title_'.$lang)}}">{{$row->getTranslations('title')[$lang]}}</textarea>
                                                </div>
                                            </div>
                                        </div>
                                    @endforeach
                                        ...
                                        <div class="col-6">
                                            <div class="form-group">
                                                <div class="controls">
                                                    ...
                                                    <textarea class="form-control" name="description[{{$lang}}]" id="" cols="30" rows="10" placeholder="{{__('site.write') . __('site.description_'.$lang)}}">{{$row->getTranslations('description')[$lang]}}</textarea>
                                                </div>
                                            </div>
                                        </div>
                                    @endforeach

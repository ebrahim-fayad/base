            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">{{ __('routes.countries.edit') }}</h4>
                    </div>
                    <div class="card-content">
                        <div class="card-body">
                            <form method="POST" action="{{ route('admin.countries.update', ['id' => $row->id]) }}"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="controls">
                                                    <input type="text" name="key" class="form-control"
                                                        placeholder="{{ __('admin.enter_country_code') }}"
                                                ...
                                                <div class="controls">
                                                    <select name="flag" id="flag-select" class="form-control select2">
                                                        @foreach ($flags as $flag)
                                                            <option value="{{$flag}}"
                                                                    @if($row->myFlag() == $flag) selected @endif

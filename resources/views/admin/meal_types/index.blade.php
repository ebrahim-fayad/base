...
<div class="content-body">
    <div class="mb-1 d-flex justify-content-between m-0">
        <x-admin.buttons
            addbutton="{{ route('admin.meal_types.create') }}"
            deletebutton="{{ route('admin.meal_types.deleteAll') }}"
        />
        <x-admin.filter
            datefilter="true"
            order="true"
...
@section('js')
    ...
    @include('admin.shared.filter_js', ['index_route' => route('admin.meal_types.index')])
@endsection

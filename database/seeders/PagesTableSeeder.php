...
class PagesTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        \DB::table('pages')->insert([
            ...
            [
                'slug'          => 'users-terms',
                'title'         => json_encode(['ar' => 'الشروط والاحكام للمستخدمين', 'en' => 'Terms and Conditions For Users'], JSON_UNESCAPED_UNICODE),
                'content'    => json_encode([
                ...
                الاتصال:
                إذا كان لديك أي أسئلة أو استفسارات حول الشروط والأحكام، يرجى الاتصال بنا عبر [ذكر وسيلة الاتصال مثل البريد الإلكتروني أو الجوال].

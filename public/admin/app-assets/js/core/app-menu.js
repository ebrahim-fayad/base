...
(function (window, document, $) {
  ...
  $.app.menu = {
    ...
    change: function (defMenu) {
      ...
      // Initialize drill down menu for vertical layout, for horizontal layout drilldown menu is intitialized in changemenu function
    ...
    changeMenu: function (screen) {
      ...
      if (screen === 'xl') {
        ...
        // Intitialize drill down menu for horizontal layout
        // --------------------------------------------------
